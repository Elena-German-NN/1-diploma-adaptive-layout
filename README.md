# Дипломный проект  - 1 курс «Адаптивная и мобильная вёрстка»
...
Локальная разработка проекта на компьютере будет в программе VSCode. Изучите [инструкцию по установке и настройке VSCode](https://github.com/netology-code/mq-diploma/blob/master/github/vscode%20setup.md).
